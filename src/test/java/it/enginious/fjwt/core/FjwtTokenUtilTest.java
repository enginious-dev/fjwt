...
class FjwtTokenUtilTest {
  ...
  @Mock private MacAlgorithm mockMacAlgorithm;
  @Mock private SecretKeyBuilder mockSecretKeyBuilder;
  ...
  @ParameterizedTest
  @CsvSource({
    "TRACE,no secret provided: 8x/A?D(G+KbPeShVmYq3t6w9y$B&E)H@ (generated with algorithm HS256) will be used",
    "INFO,no secret provided: ******************************** (generated with algorithm HS256) will be used"
  })
  void whenEmptySecretIsSuppliedShouldLogPlaintextOrMaskedGeneratedSecretAccordingToLogLevel(
      String level, String expectedMessage) {

    ((ch.qos.logback.classic.Logger) LoggerFactory.getLogger(FjwtTokenUtil.class))
        .setLevel(Level.valueOf(level));

    try (LogCaptor logCaptor = LogCaptor.forClass(FjwtTokenUtil.class);
        MockedStatic<Base64> mockedBase64 = mockStatic(Base64.class);
        MockedStatic<Jwts.SIG> mockedSig = mockStatic(Jwts.SIG.class)) {
  ...
  void whenWeakSecretIsSuppliedShouldThrowIllegalStateException() {
    try (MockedStatic<Base64> mockedBase64 = mockStatic(Base64.class)) {
      ...
      assertThatThrownBy(() -> target.init())
          ...
          .hasCauseExactlyInstanceOf(WeakKeyException.class);
    }
  }
      ...
      assertThat(logCaptor.getWarnLogs())
          .doesNotHave(
              new Condition<>(
                  lines ->
                      lines.stream()
                          .anyMatch(line -> StringUtils.startsWith(line, "no algorithm provided")),
                  "no_algorithm_provided_condition"));
    }
  }
  ...
  void whenGenerateTokenShouldReturnToken() {
    ...
    String token =
        "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJhdXRob3JpdGllcyI6WyJhdXRoMSIsImF1dGgyIl0sInN1YiI6InVzZXJuYW1lIiwiaWF0IjoxNjM1MzM5NjAwLCJleHAiOjE2MzUzNDMyMDB9.inygt8sOsMTgJ1D0CMKv_le5yQw83GGvmMKfiXj2sl0";
